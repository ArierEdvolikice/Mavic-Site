      ...
      <div className="slider-container">
        <Slider {...sliderSettings}>
          <div className="slide-item">
            <div className="image-container">
              <img
                src="/Imagens_Seção_02/Imagem_Cadeira_01.png"
          ...
          <div className="slide-item">
            <div className="image-container">
              <img
                src="/Imagens_Seção_02/Imagem_Cadeira_02.png"
          ...
          <div className="slide-item">
            <div className="image-container">
              <img
                src="/Imagens_Seção_02/Imagem_Cadeira_03.png"
          ...
          <div className="slide-item">
            <div className="image-container">
              <img
                src="/Imagens_Seção_02/Imagem_Cadeira_04.png"
          ...
          <div className="slide-item">
            <div className="image-container">
              <img
                src="/Imagens_Seção_02/Imagem_Cadeira_05.png"
